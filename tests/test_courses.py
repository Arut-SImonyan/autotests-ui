...
def test_empty_courses_list(chromium_page_with_state: Page):
    ...
    courses_list_empty_text = chromium_page_with_state.get_by_test_id("courses-list-empty-view-title-text")
    expect(courses_list_empty_text).to_be_visible()
    expect(courses_list_empty_text).to_have_text("There is no results")

    courses_list_empty_description_text = chromium_page_with_state.get_by_test_id("courses-list-empty-view-description-text")
